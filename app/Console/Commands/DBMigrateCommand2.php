...
class DBMigrateCommand2 extends Command
{
    ...
    public function handle()
    {
        ...
        $complements = [
            ...
            'copia' => null,
            'exige_resposta' => null,
            'id_quem_respondeu' => null,
            'quem_respondeu' => null,
            'atualizado' => null,
            'controle_interno' => null,
            'resolvido' => null,
            'data_resposta' => null,
            'resposta' => null,
            'respondido' => null,
            'status' => null,
            'quem_confirmo_exclusao' => null,
            'cod_encadeado' => null,
            'id_controle' => null,
            'codigo_email' => null
        ];
        ...
        foreach ($email_enviado_super as $email) {
            ...
            if (!$existeGSmail) {
                ...
                // echo $this->uuidv7_from_timestamp($data_email)."DATINHA".$email->id;
                ...
                if ($resolved_complements) {
                    $email_complements = EmailComplementDTO::validateAndCreate([
                        'complement_data' => (array) $resolved_complements,
